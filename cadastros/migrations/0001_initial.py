# Generated by Django 4.2.4 on 2023-09-05 21:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pat', models.IntegerField(unique=True, verbose_name='número')),
                ('municipio', models.CharField(choices=[('selviria', 'Selvíria'), ('inocencia', 'Inocência')], max_length=50)),
                ...
                ('pessoa', models.CharField(blank=True, choices=[('fisica', 'Física'), ('juridica', 'Jurídica')], max_length=50, null=True)),
