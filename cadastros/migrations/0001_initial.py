    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valtrib', models.CharField(blank=True, max_length=10, null=True)),
                ('valmul', models.CharField(blank=True, max_length=10, null=True)),
                ('valcred', models.CharField(blank=True, max_length=10, null=True)),
                ('valatu', models.CharField(blank=True, max_length=10, null=True)),
