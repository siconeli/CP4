    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valmul', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('valcred', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('valatu', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
