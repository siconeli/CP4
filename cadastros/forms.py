...
class CadProcessoAdmForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['pat', 'municipio', 'uf', 'datini', 'datfin', 'datdivat', 'valtrib', 'valmul', 'valcred', 'valatu', 'datvalatu', 'nomecontribuinte', 'pessoa', 'doc', 'nomefantasia', 'email', 'endereco', 'complemento', 'municipiocontri', 'ufcontri', 'cep', 'tel', 'cel']


class AndamentoForm(forms.ModelForm):
    class Meta:
        model = Andamento
        fields = ['processo', 'datandamento', 'andamento', 'dias', 'dataprazo', 'funcionario', 'datrecebimento', 'complemento', 'arq1', 'arq2', 'arq3', 'arq4', 'arq5', 'arq6']
